...
import 'package:ecommerce_mobile/screens/product_display_screen.dart';
...
class _ProductListState extends State<ProductList> {
  ...
  Widget _buildResultView() {
    ...
    List<Widget> list = data!.items!.map((x) => GestureDetector(
    onTap: (){

   Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => ProductDisplayScreen(product: x)));
